...
/***/ 41:
/*!***************************************************************************!*\
  !*** E:/Vue 项目实战/neteaseMusic/main.js?{"page":"pages%2Fsearch%2Fsearch"} ***!
  \***************************************************************************/
...
/***/ 42:
/*!********************************************************!*\
  !*** E:/Vue 项目实战/neteaseMusic/pages/search/search.vue ***!
  \********************************************************/
/*! no static exports found */
...
/***/ 43:
/*!***************************************************************************************************!*\
  !*** E:/Vue 项目实战/neteaseMusic/pages/search/search.vue?vue&type=template&id=4cedc0c6&scoped=true& ***!
  \***************************************************************************************************/
...
/***/ 45:
/*!*********************************************************************************!*\
  !*** E:/Vue 项目实战/neteaseMusic/pages/search/search.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  onLoad: function onLoad() {var _this = this;
    ...
    uni.getStorage({
      ...
      success: function success(res) {
        _this.searchWordList = res.data;

      } });

  },
  methods: {
    handleToHot: function handleToHot(key) {
      this.searchWord = key;
    },
    handleToSearch: function handleToSearch() {var _this2 = this;
      this.searchType = 2;
      this.searchWordList.unshift(this.searchWord);
      this.searchWordList = _toConsumableArray(new Set(this.searchWordList));
      ...
      (0, _api.searchWord)(this.searchWord).then(function (res) {
        if (res[1].statusCode === 200) {
          _this2.songSearchList = res[1].data.result.songs;
          // console.log(this.songSearchList);
        }

      });
    },
    handleToWord: function handleToWord(val) {
      this.searchWord = val;
    ...
    handleToDeatil: function handleToDeatil(songId) {
      uni.navigateTo({
        url: "/pages/detail/detail?songId=".concat(songId) });

    },
    handleToSuggest: function handleToSuggest(e) {var _this4 = this;
      this.searchType = 3;
...
/***/ 47:
/*!*****************************************************************************************************************!*\
  !*** E:/Vue 项目实战/neteaseMusic/pages/search/search.vue?vue&type=style&index=0&id=4cedc0c6&scoped=true&lang=css& ***!
  \*****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
